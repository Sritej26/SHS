...
urlpatterns = [
    ...
    re_path(r'^patientRecords/searchs/(?P<id>(.*))$', views.updatePatientDetails.as_view(), name='updatePatientDetails'),
    re_path(r'^diagnosis/searchDiagnosiss/(?P<id>(.*))$', views.updatePatientDiagnosis.as_view(), name='updatePatientDiagnosis'),
