...
urlpatterns = [
    ...
    re_path(r'^updateEmployeeDetails/update/(?P<id>(.*))$', views.updateEmployeeDetails.as_view(), name='updateEmployeeDetails'),
    re_path(r'^updateEmployeeDetails/delete/(?P<id>(.*))$', views.deleteEmployeeRecord.as_view(), name='deleteEmployeeRecord'),
