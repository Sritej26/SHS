...
urlpatterns = [
    ...
    re_path(r'^appointmentTransactionRequests/(?P<id>(.*))$', views.appointmentTransactionRequests.as_view(), name='appointmentTransactionRequests'),
    re_path(r'^insuranceTransactionRequests/(?P<id>(.*))$', views.insuranceTransactionRequests.as_view(), name='insuranceTransactionRequests'),
    ...
    re_path(r'^logout/(?P<id>(.*))$', LogoutView.as_view(), name='logout'),
]